...
public class Board2 {
    ...
    public Iterable<Board2> neighbors(){
        ...
        MinPQ<Board2> q = new MinPQ<Board2>(new Comparator<Board2>() {
            public int compare(Board2 o1, Board2 o2) {
