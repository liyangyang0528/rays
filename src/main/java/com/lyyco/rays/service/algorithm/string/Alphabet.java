package com.lyyco.rays.service.algorithm.string;

import edu.princeton.cs.algs4.StdOut;

/**
 * a data type for alphabets
 * for use with string-processing code that
 * must between an alphabet of size R
 * and the integers 0 through R-1
 * Author liyangyang
 * 2018/8/17
 */
